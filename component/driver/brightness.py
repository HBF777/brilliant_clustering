...
class driver(Basedriver):
    ...
    def get_data(self):
        ...
        self.TSL2591_SET_LuxInterrupt(50, 200)
        infrared = self.Read_Infrared

        visible = self.Read_Visible

        full_spectrum = self.Read_FullSpectrum

        data = {'infrared': infrared, 'visible': visible,'full_spectrum':full_spectrum,"time": time.time()}
        return data
